...
def strat(data):
    ...
    MAX_HOLDING_PERIOD = 21 * 24    # 2 weeks in hours
...
def perform_backtest(csv_file_path):
    ...
    result = client.backtest(
        jupyter_id="g.sandeep",  # the one you use to login to jupyter.untrade.io
...
def main():
    ...
    # Set file paths here
    BTC_CSV_PATH_1H = "D:/focus/Quant/Inter/BTC_2019_2023_1h.csv"
    ETH_CSV_PATH_1H = "D:/focus/Quant/Inter/ETHUSDT_1h.csv"
    ...
    csv_file_path = "STRATEGY_RESULTS_CSV_OUTPUT_PATH.csv"
